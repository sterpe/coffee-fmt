...
exports.Lexer = Lexer = (function() {
  ...
  Lexer.prototype.commentToken = function() {
    var comment, comment_text, here, match;
    ...
    if (here) {
      ...
      this.token("COMMENT", comment_text, 0, comment_text.length);
    }
  ...
  Lexer.prototype.lineToken = function() {
    ...
    if (this.verbose) {
      ...
      console.log("CHUNK SLICE HERE: ", this.chunk.slice(0, 50));
    }
    if (this.chunk.charAt(indent.length) === "#") {
      this.newlineToken(0);
      return 1;
    }
    this.seenFor = false;
  ...
  Lexer.prototype.closeIndentation = function() {
    if (this.verbose) {
      console.log("CLOSE_INDENTATION", this.indent);
    }
