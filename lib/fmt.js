...
PADDED_LR_TYPES = ["UNARY", "LOGIC", "SHIFT", "COMPARE", "COMPOUND_ASSIGN", "MATH", "RELATION", "FORIN", "FOROF", "INSTANCEOF", "UNLESS", "IF", "THEN", "ELSE", "OWN", "WHEN", "LEADING_WHEN", "=", "->", "FOR", "BY", "RETURN", "THROW", "WHILE", "SWITCH", "+", "CLASS", "-"];
...
fmt = function(code, options) {
  ...
  _fn = function(i) {
    var inline, j, tmp, token, _fn1, _j, _ref1, _ref2, _ref3, _ref4;
    token = tokens[i];
